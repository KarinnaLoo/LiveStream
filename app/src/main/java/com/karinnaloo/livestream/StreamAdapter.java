            ...
            if (isActionContainerVisible(listItemParent)) {
                ...
                if (mUsername != null) {
                    ...
                    if (mUsername.compareTo(getItem(((Integer) overflowBtn.getTag())).getOwnerName()) == 0) {
                        ((ImageButton) actionContainer.findViewById(R.id.flagBtn)).setImageResource(R.drawable.live_orange_bg);
                    } else {
                        ((ImageButton) actionContainer.findViewById(R.id.flagBtn)).setImageResource(R.drawable.live_red_bg);
                    }
                }
